...
; ---------------------------------------------------------------------------------------------------------------------------------------
		...
		ldi 	ColourPage									; COLOUR: the rocks are plotted into bit plane 1 instead of
...
RestartCurrentLevel:
		...
		plo 	rd
RCL_Clear: 													; COLOUR: clear BOTH planes, or last level's rocks stay on the
...
CBP_Plane1:
		...
		glo 	ra
		bnz 	CBP_Plane1
		ldi 	VideoPage 									; ...then plane 0, so RA ends at $1200 as before
		phi 	ra
		ldi 	0
		plo 	ra
CBP_Plane0:
